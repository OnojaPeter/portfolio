    ...
    return (
        <div>
            <div className="px-8 mx-auto mb-[224px] max-w-screen-2xl md:px-12" id="About">
                <h1 className="mb-24 text-3xl font-semibold text-center text-gray-300 uppercase font-poppins">About me</h1>

                <div className="flex flex-col flex-wrap items-center justify-between gap-10 mx-auto md:flex-row">
                    <div>
                        <img className="w-80 rounded-xl" src="/avatar.jpg" alt="Peter" />
                    </div>
                    ...
                    <div className="flex flex-col flex-wrap max-w-3xl gap-5  ">
                        ...
                        <div className="flex flex-col gap-4 md:flex-row md:gap-48">
                            <div className="mb-4">
