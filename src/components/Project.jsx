...
function Project() {
    ...
    return (
        <div className="px-8 mx-auto mb-[80px] md:mb-[224px] max-w-screen-2xl md:px-12" id="Project">
            <div className="flex flex-col items-center gap-6">
                ...
                <div className="grid gap-8 md:px-8 grid md:grid-cols-2 xl:grid-cols-3">
